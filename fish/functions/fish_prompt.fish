...
function fish_prompt
    ...
    echo (set_color brmagenta)(date "+%d %b,")(set_color magenta) (date "+%Y @ %H:%M:%S")(set_color brblue)" | "(set_color brgreen)(whoami)(set_color brblue)@(set_color normal)(hostname)
    ...
    if test $branchlength -gt 0
        ...
        echo (set_color brmagenta)"["(set_color yellow)(fish_git_prompt %s)(set_color brmagenta)"]"(set_color --bold brmagenta)"➜  "(set_color normal)
    else
